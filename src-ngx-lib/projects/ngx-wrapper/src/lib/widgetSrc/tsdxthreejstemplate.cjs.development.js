        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              ...
              this._controls = !this._isWorldFlippable ? new OrbitControls.OrbitControls(this._camera, this._renderer.domElement) : new TrackballControls.TrackballControls(this._camera, this._renderer.domElement);

              if (!(this._controls instanceof OrbitControls.OrbitControls)) {
                _context2.next = 29;
                break;
              }
            ...
            case 29:
              if (!(this._controls instanceof TrackballControls.TrackballControls)) {
                _context2.next = 36;
                break;
              }
            ...
            case 0:
              return _context.abrupt("return", new Promise(function (resolve) {
                ...
                var onObjectLoad = function onObjectLoad(loadedObject) {
                  ...
                  var helperBox = new THREE.BoxHelper(loadedObject, 0xffff00);
                  ...
                  loadedObject.traverse(function (child) {
                    ...
                    if (child.type === 'DirectionalLight') {
                      ...
                      var newDirectionalLight = new THREE.DirectionalLight();
                      newDirectionalLight.position.set(x * s, y * s, z * s);
                      newDirectionalLight.intensity = directionalLightClone.intensity;
                      var helper = new THREE.DirectionalLightHelper(newDirectionalLight, 5, 'pink');
          ...
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", new Promise(function (resolve) {
                ...
                // Add light helper
                var helper = new THREE.DirectionalLightHelper(_this2._light.clone(), 5, 'cyan');
                helper.userData.isHelper = true;
                helper.visible = true;
